...
@Component({
  selector: 'ai-validator-configuration',
  templateUrl: './ai-validator-configuration.html',
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => AiValidatorConfiguration),
      multi: true,
    },
    {
...
export class AiValidatorConfiguration
  implements OnInit, ControlValueAccessor, Validator
{
  ...
  private _buildForm(): FormGroup<IConfigurationForm> {
    return this._fb.group<IConfigurationForm>({
      ...
      expectedSchema: this._fb.control(null, [Validators.required]),
    });
  }
