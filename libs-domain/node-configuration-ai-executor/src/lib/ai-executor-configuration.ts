...
@Component({
  selector: 'ai-executor-configuration',
  templateUrl: './ai-executor-configuration.html',
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => AiExecutorConfiguration),
      multi: true,
    },
    {
...
export class AiExecutorConfiguration
  implements OnInit, ControlValueAccessor, Validator
{
  ...
  private _buildForm(): FormGroup<IConfigurationForm> {
    return this._fb.group<IConfigurationForm>({
      ...
      resultType: this._fb.control(null, [Validators.required]),
    });
  }
