...
@Component({
  selector: 'ai-parser-configuration',
  templateUrl: './ai-parser-configuration.html',
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => AiParserConfiguration),
      multi: true,
    },
    {
...
export class AiParserConfiguration
  implements OnInit, ControlValueAccessor, Validator
{
  ...
  private _buildForm(): FormGroup<IConfigurationForm> {
    return this._fb.group<IConfigurationForm>({
      ...
      outputFormat: this._fb.control(null, [Validators.required]),
    });
  }
